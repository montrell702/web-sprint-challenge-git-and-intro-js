...
console.log('print first artist', artists[0].name);


//(2) Bio of the third artist (2nd index) in the array 

console.log('3rd artist bio', artists[2].bio)

/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2 (not auto tested): 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
(no function needed) 
There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Fix this issue and console.log() to check your work. */

console.log('original artists name',artists[8].name)
artists[8].name = 'Vincent Van Gogh';
console.log('updated artists name',artists[8].name)
...
console.log('list of names', listOfNames(artists))
...
function addArtist(array, name, genre, nationality, bio) {

  const newArray =[...artists];

   var newObject = {
name:"Montrell Shannon",
years:"1980-2022",
...
function artistInfo(array, name){
  ...
  artistInfo()
  console.log("task 8", `Frida Kahlo`,bio[17]);
...
for (let i = 0; i <  artists.length; i++);
   if (nationality ===2)
 console.log("task 9", artistByCountry,artist,spanish)
